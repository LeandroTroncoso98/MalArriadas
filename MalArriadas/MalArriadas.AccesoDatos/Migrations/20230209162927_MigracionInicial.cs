    ...
    public partial class MigracionInicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TalleId = table.Column<int>(name: "Talle_Id", type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Nombre = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Articulo_Marca_Marca_Id",
                        column: x => x.MarcaId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_articuloTalle", x => new { x.TalleId, x.ArticuloId });
                    table.ForeignKey(
                        name: "FK_articuloTalle_Articulo_Articulo_Id",
                        column: x => x.ArticuloId,
                        principalTable: "Articulo",
                        principalColumn: "Articulo_Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_articuloTalle_Talle_Talle_Id",
                        column: x => x.TalleId,
                        principalTable: "Talle",
                        principalColumn: "Talle_Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Articulo_Marca_Id",
                table: "Articulo",
                column: "Marca_Id");

            migrationBuilder.CreateIndex(
                name: "IX_articuloTalle_Articulo_Id",
                table: "articuloTalle",
                column: "Articulo_Id");
